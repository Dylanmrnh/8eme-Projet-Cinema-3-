    ...
    <br>
      ...
      <div class="content">
        ...
        <p> Note: {{films.vote_average}}/10</p>
          ...
          <div class="card">
                <div v-for="unFilm in cast.cast" v-bind:key="unFilm.key">
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      // https://api.themoviedb.org/3/movie/335983/recommendations?api_key=3f2e73f99471592447bae321c22cd045&language=fr
    }
  }
</script>
